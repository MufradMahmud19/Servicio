...
if(isset($_POST['submit'])) {
   ...
   $playlist = filter_var($playlist, FILTER_SANITIZE_STRING);
      ...
      $add_playlist = $conn->prepare("INSERT INTO `content`(id, tutor_id, playlist_id, title, description, status) VALUES(?,?,?,?,?,?)");
      $add_playlist->execute([$id, $tutor_id, $playlist, $title, $description, $status]);
      $message[] = 'new service uploaded!';

}
else{
   echo "file couldn't uploded";
}
