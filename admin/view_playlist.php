...
<head>
   ...
   <title>Servicelist Details</title>
...
<section class="playlist-details">
   ...
   <h1 class="heading">servicelist details</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">update servicelist</a>
...
<section class="contents">
   ...
   <h1 class="heading">servicelist videos</h1>
