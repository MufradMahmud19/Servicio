...
<section class="playlists">
   ...
   <h1 class="heading">added service</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">create new service</h3>
         <a href="add_playlist.php" class="btn">add service</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">view service</a>
      </div>
      <?php
         } 
      }else{
