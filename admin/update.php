      ...
      <div class="flex">
         <div class="col">
            ...
            <select name="profession" class="box">
               ...
               <option value="washing/cleaning service">washing/cleaning service</option>
               <option value="baby sitting service">baby sitting service</option>
               <option value="cooking service">cooking service</option>
               <option value="health care service">health care service</option>
               <option value="tutoring service">tutoring service</option>
               <option value="car mechanic service">car mechanic service</option>
            </select>
            <p>your email </p>
