...
<section class="teachers">
   ...
   <h1 class="heading">expert employees</h1>

   <form action="search_tutor.php" method="post" class="search-tutor">
      <input type="text" name="search_tutor" maxlength="100" placeholder="search employee..." required>
   ...
   <div class="box-container">
      ...
      <div class="box offer">
         <h3>become an employee</h3>
         <p>come and join SERVICIO Family</p>
